<template>
  <div class="table-container">
    ...
    >
      ...
      <el-table-column label="代碼" prop="c_type" show-overflow-tooltip sortable width="95" />
      <el-table-column label="名稱" prop="c_type_name" show-overflow-tooltip />
