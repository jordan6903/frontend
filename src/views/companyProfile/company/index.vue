<template>
  <div class="table-container">
        ...
        <el-form ref="form" :inline="true" :model="queryForm" @submit.native.prevent>
          ...
          <el-form-item label="分類">
            <el-select v-model="queryForm.type" placeholder="請選擇分類">
              ...
              <el-option v-for="type in list_type" :key="type.c_type" :label="type.c_type + ' ' + type.c_type_name" :value="type.c_type" />
            </el-select>
          </el-form-item>
        </el-form>
      </vab-query-form-left-panel>
    ...
    >
      ...
      <el-table-column label="代碼" prop="c_id" show-overflow-tooltip sortable width="150" />
      <el-table-column label="分類" prop="c_type_name" show-overflow-tooltip sortable width="100" />
