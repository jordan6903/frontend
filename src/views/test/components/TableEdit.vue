  ...
  <el-dialog :title="title" :visible.sync="dialogFormVisible" width="500px" @close="close">
    <el-form ref="form" label-width="80px" :model="form" :rules="rules">
      <el-form-item label="ID" prop="device_id">
        <el-input v-model.trim="form.device_id" @input="toUpperCase($event)" :disabled="form_lock" autocomplete="off" maxlength="5"/>
      </el-form-item>
      ...
      <el-form-item label="排序" prop="sort">
        <el-input v-model.number="form.sort" type="number" autocomplete="off" maxlength="3"/>
      </el-form-item>
    </el-form>
