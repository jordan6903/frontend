<template>
  <div class="table-container">
    ...
    >
      ...
      <el-table-column label="ID" prop="id" show-overflow-tooltip sortable width="95" />
      <el-table-column label="TT_ID" prop="tT_id" show-overflow-tooltip sortable width="250" />
      <el-table-column label="漢化組" prop="t_Name" show-overflow-tooltip />
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        url: 'http://localhost:5252/api/translation_team_batch',
        url_type: {
