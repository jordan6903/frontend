<template>
  <div class="table-container">
    ...
    >
      ...
      <el-table-column label="寬" prop="width" show-overflow-tooltip />
      <el-table-column label="高" prop="height" show-overflow-tooltip />
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        url: 'http://localhost:5252/api/company_pic',
