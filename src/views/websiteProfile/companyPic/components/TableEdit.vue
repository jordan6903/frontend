    ...
    <el-form ref="form" label-width="80px" :model="form" :rules="rules">
      <template v-if="!form_lock">
        ...
        <el-form-item label="公司代碼" prop="c_id">
          <el-select v-model="form.c_id" placeholder="請選擇公司">
      ...
      <el-form-item label="寬" prop="width">
        <el-input v-model.number="form.width" autocomplete="off" maxlength="5" type="number" />
      </el-form-item>
      <el-form-item label="高" prop="height">
        <el-input v-model.number="form.height" autocomplete="off" maxlength="5" type="number" />
      </el-form-item>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          width: [{ required: true, trigger: 'blur', message: '請輸入寬' }],
          height: [{ required: true, trigger: 'blur', message: '請輸入高' }],
        },
        title: '',
        ...
        this.$refs['form'].validate(async (valid) => {
          if (valid) {
            if (!this.form_lock) {
              console.log('新增')
              this.title = '新增'
              this.url = 'http://localhost:5252/api/company_pic'
              ...
              console.log('編輯')
              this.title = '編輯'
              this.url = `http://localhost:5252/api/company_pic/${this.form.id}`
              this.params = this.form
